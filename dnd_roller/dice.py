...
# this module contains all the functions that implement the main core functionalities of our dnp-roller

# a function to roll a single die that must be ine if the 7 dice e.g. roll
# a function to roll a single die, multiple times e.g. dice_roll
# a function that receive a sequence of dice rolls that generates a tabular report
...
def dice_roll(throws: int, sides: int) -> list[int]:
    """Rolls a single die with given 'sides' and 'throws' number of times"""
